    ...
    <>
        <div className="bg" id={bg_id}>
            ...
            <div className="search">
                <input type="text" className="searchbox" placeholder="Learn..." autoComplete="off" id={input_id}
                ...
                <div className="searchbox-autocomplete" id={searchbox_autocomplete_id}
            ...
            <button className="searchbtn" type="submit" onClick={e => {
                ...
                <svg width="24px" strokeWidth="1.5" height="24px" viewBox="0 0 24 24" fill="none"
                     xmlns="http://www.w3.org/2000/svg" color="#000000">
                    <path d="M5 19.5V5C5 3.89543 5.89543 3 7 3H18.4C18.7314 3 19 3.26863 19 3.6V21" stroke="white"
                          strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M9 7L15 7" stroke="white" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M6.5 15L19 15" stroke="white" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M6.5 18L19 18" stroke="white" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M6.5 21L19 21" stroke="#fff" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M6.5 18C5.5 18 5 17.3284 5 16.5C5 15.6716 5.5 15 6.5 15" stroke="#fff" strokeWidth="1.5"
                          strokeLinecap="round" strokeLinejoin="round"></path>
                    <path d="M6.5 21C5.5 21 5 20.3284 5 19.5C5 18.6716 5.5 18 6.5 18" stroke="#fff" strokeWidth="1.5"
                          strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
                Learn
            </button>
